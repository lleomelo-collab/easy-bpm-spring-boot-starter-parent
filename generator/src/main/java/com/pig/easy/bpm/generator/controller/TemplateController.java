...
public class TemplateController {
    ...
    @Operation(summary = "查询模板表列表", description = "查询模板表列表")
    ...
    @Operation(summary = "新增模板表", description = "新增模板表")
    @PostMapping("/insert")
    ...
    @Operation(summary = "修改模板表", description = "修改模板表")
    @PostMapping("/update")
    ...
    @Operation(summary = "删除模板表", description = "删除模板表")
    ...
    @Operation(summary = "下载模板表", description = "下载模板表")
    ...
    @Operation(summary = "根据编号获取模板表", description = "根据编号获取模板表")
    @PostMapping("/getById")
