...
public class ProcessController {
    ...
    @Operation(summary = "根据流程编号获取流程详细信息")
    ...
    @Operation(summary = "根据流程KEY获取流程详细信息")
