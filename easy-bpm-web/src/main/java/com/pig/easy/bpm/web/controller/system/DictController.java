...
public class DictController {
    ...
    @Operation(summary = "查询字典表列表", description = "查询字典表列表")
    ...
    @Operation(summary = "删除字典表", description = "删除字典表")
    ...
    @Operation(summary = "下载字典表", description = "下载字典表")
    ...
    @Operation(summary = "根据编号获取字典表", description = "根据编号获取字典表")
    @PostMapping("/getById")
    ...
    @Operation(summary = "查询字典值", description = "查询字典值")
    ...
    @Operation(summary = "查询角色字典", description = "查询角色字典")
    ...
    @Operation(summary = "查询角色组字典", description = "查询角色组字典")
    ...
    @Operation(summary = "查询部门字典", description = "查询部门字典")
    ...
    @Operation(summary = "获取流程列表字典", description = "获取流程列表字典")
