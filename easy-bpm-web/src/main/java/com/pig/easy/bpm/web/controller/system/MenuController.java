...
public class MenuController {
    ...
    @Operation(summary = "查询菜单表列表", description = "查询菜单表列表")
    ...
    @Operation(summary = "修改菜单表", description = "修改菜单表")
    @PostMapping("/update")
    ...
    @Operation(summary = "下载菜单表", description = "下载菜单表")
    ...
    @Operation(summary = "查询树形菜单", description = "查询树形菜单")
    ...
    @Operation(summary = "根据编号获取菜单表", description = "根据编号获取菜单表")
    @PostMapping("/getById")
