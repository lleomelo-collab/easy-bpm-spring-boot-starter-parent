...
public class MessageContentController extends BaseController {
    ...
    @Operation(summary = "查询通知内容表列表", description = "查询通知内容表列表")
    ...
    @Operation(summary = "新增通知内容表", description = "新增通知内容表")
    @PostMapping("/insert")
    ...
    @Operation(summary = "修改通知内容表", description = "修改通知内容表")
    @PostMapping("/update")
    ...
    @Operation(summary = "删除通知内容表", description = "删除通知内容表")
    ...
    @Operation(summary = "下载通知内容表", description = "下载通知内容表")
    ...
    @Operation(summary = "根据编号获取通知内容表", description = "根据编号获取通知内容表")
    @PostMapping("/getById")
